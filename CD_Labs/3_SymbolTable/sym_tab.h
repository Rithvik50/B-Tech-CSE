...
void insert_into_table(symbol* s); // Inserts a new symbol into the table

int check_symbol_table(char* name); // Checks if a variable exists in the symbol table

void insert_value_to_name(char* name, char* value, int type); // Assigns a value to a variable in the symbol table
